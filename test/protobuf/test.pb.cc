...
class LoginRequesDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<LoginReques> _instance;
...
static void InitDefaultsscc_info_LoginReques_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_LoginReques_default_instance_;
    new (ptr) ::fixbug::LoginReques();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::LoginReques::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LoginReques_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_LoginReques_test_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginReques, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginReques, name_),
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginReques, pwd_),
  ~0u,  // no _has_bits_
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_LoginReques_default_instance_),
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ".fixbug.LoginReques\032\025.fixbug.LoginRespon"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[6] = {
  ...
  &scc_info_LoginReques_test_2eproto.base,
...
void LoginReques::InitAsDefaultInstance() {
}
class LoginReques::_Internal {
 public:
};

LoginReques::LoginReques()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.LoginReques)
}
LoginReques::LoginReques(const LoginReques& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.LoginReques)
}

void LoginReques::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LoginReques_test_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  pwd_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

LoginReques::~LoginReques() {
  // @@protoc_insertion_point(destructor:fixbug.LoginReques)
  SharedDtor();
}

void LoginReques::SharedDtor() {
  name_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  pwd_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void LoginReques::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const LoginReques& LoginReques::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_LoginReques_test_2eproto.base);
  return *internal_default_instance();
}


void LoginReques::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.LoginReques)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* LoginReques::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* LoginReques::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.LoginReques)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.LoginReques)
  return target;
}

size_t LoginReques::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.LoginReques)
  size_t total_size = 0;
...
void LoginReques::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.LoginReques)
  GOOGLE_DCHECK_NE(&from, this);
  const LoginReques* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<LoginReques>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.LoginReques)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.LoginReques)
    MergeFrom(*source);
  }
}

void LoginReques::MergeFrom(const LoginReques& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.LoginReques)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void LoginReques::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.LoginReques)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void LoginReques::CopyFrom(const LoginReques& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.LoginReques)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool LoginReques::IsInitialized() const {
  return true;
}

void LoginReques::InternalSwap(LoginReques* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata LoginReques::GetMetadata() const {
  return GetMetadataStatic();
}
...
void UserServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      Login(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::LoginReques*>(
                 request),
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fixbug::LoginReques::default_instance();
    case 1:
...
template<> PROTOBUF_NOINLINE ::fixbug::LoginReques* Arena::CreateMaybeMessage< ::fixbug::LoginReques >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::LoginReques >(arena);
}
