...
class LoginReques;
class LoginRequesDefaultTypeInternal;
extern LoginRequesDefaultTypeInternal _LoginReques_default_instance_;
class LoginResponse;
...
template<> ::fixbug::LoginReques* Arena::CreateMaybeMessage<::fixbug::LoginReques>(Arena*);
...
class LoginReques :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.LoginReques) */ {
 public:
  LoginReques();
  virtual ~LoginReques();

  LoginReques(const LoginReques& from);
  LoginReques(LoginReques&& from) noexcept
    : LoginReques() {
    *this = ::std::move(from);
  }

  inline LoginReques& operator=(const LoginReques& from) {
    CopyFrom(from);
    return *this;
  }
  inline LoginReques& operator=(LoginReques&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const LoginReques& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const LoginReques* internal_default_instance() {
    return reinterpret_cast<const LoginReques*>(
               &_LoginReques_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(LoginReques& a, LoginReques& b) {
    a.Swap(&b);
  }
  inline void Swap(LoginReques* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline LoginReques* New() const final {
    return CreateMaybeMessage<LoginReques>(nullptr);
  }

  LoginReques* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<LoginReques>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const LoginReques& from);
  void MergeFrom(const LoginReques& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(LoginReques* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.LoginReques";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.LoginReques)
 private:
  class _Internal;
...
class UserServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       const ::fixbug::LoginReques* request,
...
// bytes name = 1;
inline void LoginReques::clear_name() {
  name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& LoginReques::name() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginReques.name)
  return _internal_name();
}
inline void LoginReques::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginReques.name)
}
inline std::string* LoginReques::mutable_name() {
  // @@protoc_insertion_point(field_mutable:fixbug.LoginReques.name)
  return _internal_mutable_name();
}
inline const std::string& LoginReques::_internal_name() const {
  return name_.GetNoArena();
}
inline void LoginReques::_internal_set_name(const std::string& value) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void LoginReques::set_name(std::string&& value) {
  
  name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.LoginReques.name)
}
inline void LoginReques::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.LoginReques.name)
}
inline void LoginReques::set_name(const void* value, size_t size) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.LoginReques.name)
}
inline std::string* LoginReques::_internal_mutable_name() {
  
  return name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* LoginReques::release_name() {
  // @@protoc_insertion_point(field_release:fixbug.LoginReques.name)
  
  return name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void LoginReques::set_allocated_name(std::string* name) {
  if (name != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginReques.name)
}

// bytes pwd = 2;
inline void LoginReques::clear_pwd() {
  pwd_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& LoginReques::pwd() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginReques.pwd)
  return _internal_pwd();
}
inline void LoginReques::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginReques.pwd)
}
inline std::string* LoginReques::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:fixbug.LoginReques.pwd)
  return _internal_mutable_pwd();
}
inline const std::string& LoginReques::_internal_pwd() const {
  return pwd_.GetNoArena();
}
inline void LoginReques::_internal_set_pwd(const std::string& value) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void LoginReques::set_pwd(std::string&& value) {
  
  pwd_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.LoginReques.pwd)
}
inline void LoginReques::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.LoginReques.pwd)
}
inline void LoginReques::set_pwd(const void* value, size_t size) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.LoginReques.pwd)
}
inline std::string* LoginReques::_internal_mutable_pwd() {
  
  return pwd_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* LoginReques::release_pwd() {
  // @@protoc_insertion_point(field_release:fixbug.LoginReques.pwd)
  
  return pwd_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void LoginReques::set_allocated_pwd(std::string* pwd) {
  if (pwd != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginReques.pwd)
}
